...
export function WatchlistCard({ item }: { item: WatchlistItem }) {
  return (
    <a
      ...
      className="group relative flex flex-col overflow-hidden rounded-xl bg-zinc-900 aspect-[3/4] ring-1 ring-white/10 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
    >
      {item.poster ? (
        item.source === 'youtube' ? (
          <>
